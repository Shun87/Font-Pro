...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    FontPreviewController *viewController3 = [[[FontPreviewController alloc] initWithNibName:@"FontPreviewController" bundle:nil] autorelease];
    viewController3.title = NSLocalizedString(@"Text", @"Text");
    ...
    self.tabBarController.viewControllers = [NSArray arrayWithObjects:navigationController1, navigationController2, sysmbolNav, navigationController4, nil];
